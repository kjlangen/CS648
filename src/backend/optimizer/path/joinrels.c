...
make_join_rel(PlannerInfo *root, RelOptInfo *rel1, RelOptInfo *rel2)
{
	 ...
	 * CS448
	 * YOUR CODE HERE
	 * You can check the root->glob->forcedjoins list, and see if it is applicable
	 * to the current rel1 and rel2 of this joinrel.
	 * You can use the function bms_equal to check if two bitmapset objects are equal.
