...
/*
 * CS448 - ForcedJoin
 * This struct should contain information about a user join hint that is
 * mentioned in the query.
 * We created the enum type ForcedJoinAlgorithm to indicate the type of
 * the algorithm that the user wants to enforce.
 */
typedef enum
{
	HASH_JOIN,
...
typedef struct ForcedJoin
{
	ForcedJoinAlgorithm   join_algorithm;
...
typedef struct JoinExpr
{
	...
	/*
	 * CS448 - we modified this node to indicate if the user wants to
	 * force a specific join algorithm, and what algorithm to force
	 */
	bool			isForcedJoin;
